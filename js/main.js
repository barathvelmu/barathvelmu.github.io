    ...
    document.addEventListener("click", (event) => {
        if (event.target.classList.contains('link-item')) {
            ...
            if(event.target.hash !== "") {
                ...
                // add hash (#) to url
                window.location.hash = hash; //show in url
            }
        } 
    })
...
(() => {
    ...
    tabsContainer.addEventListener('click', (event) => {
        /* if event.target has 'tab-item' class but no 'active' class */
        if(event.target.classList.contains("tab-item") &&
          !event.target.classList.contains("active")) {
           ...
           //deactive existing active 'tab-content' remov
           aboutSection.querySelector(".tab-content.active").classList.remove("active");
           //activate existing active 'tab-content' remov
...
(() => {
    ...
    /* ------------------------ filter portfolio items  ------------------------ */
     filterContainer.addEventListener("click", (event) => {
        ...
        //activate new active 'filter-item' 
        event.target.classList.add("active", "outer-shadow");
        const target = event.target.getAttribute("data-target");
    ...
    function popupSlideshow() {
        ...
        //activate loader until image loaded
        popup.querySelector(".pp-loader").classList.add("active");
        popupImg.src = imgSrc;
        popupImg.onload = () => {
            // deactivate loader animation after popup Img loads
    ...
    function popupDetails() {
        // if portfolio-item-details dont exist
        if (!portfolioItems[itemIndex].querySelector(".portfolio-item-details")) {
            projectDetailsBtn.style.display = "none";
            return; //end function execution because nothing to really do here
        } 
        ...
        popup.querySelector(".pp-project-category").innerHTML = category.split("-").join(" "); //sets category of projects
